...
class _MealDetailsPageState extends State<MealDetailsPage> {
  ...
  ValueNotifier<int> currentValue = ValueNotifier<int>(1);
  ...
  void updateCurrentValue() {
    currentValue.value = int.tryParse(controller.text) ?? 1;
  }
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          if (snapshot.data!.isNotEmpty) {
                            var limitedData = snapshot.data!.take(15).toList();
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Padding(
                                ...
                                Column(
                                  children: List.generate(
                                    limitedData.length,
                                    (i) =>
                                        IngBox(ingredient: snapshot.data![i]),
                                  ),
                                ),
                              ],
                            );
                                ...
                                children: [
                                  ...
                                  ValueListenableBuilder<int>(
                                    ...
                                    builder: (context, value, child) {
                                      return Text(
                                        '${widget.meal.carbohydrates * value}',
